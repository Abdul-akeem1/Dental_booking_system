...
import { Google, ArrowRight } from 'lucide-react'; // Assuming Google icon availability or use text
import './LoginIn.css';
...
const LoginIn = () => {
    ...
    return (
        <div className="login-page">
                        ...
                        {isLogin ? (
                            <>
                                ...
                                <p className="toggle-text">
                                    No account? <button onClick={() => setIsLogin(false)} className="link-btn">Create one</button>
                                </p>
                            </>
                        ) : (
                            <p className="toggle-text">
            ...
            {/* Footer might be too heavy for a login page like this, but keeping it as requested/implied structure */}
            {/* <Footer /> */}
        </div>
    );
};
