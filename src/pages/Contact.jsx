            ...
            <main className="contact-main">
                <section className="contact-hero">
                    <div className="container">
                        <h1>Contact Us</h1>
                        <p className="lead-text">Get in touch to book an appointment or ask any questions.</p>
                    </div>
                </section>
                ...
                <div className="container contact-content">
                    <div className="contact-info">
                        <h2>Get In Touch</h2>
                        <p className="info-intro">We look forward to welcoming you to our clinic.</p>
